...
public class CompareStr {
	...
	public static void main(String[] args) {
        ...
        */
		...
		User kim = new User("abc1234", "aaa1111");   //참조변수 공간에 아이디와 비밀번호 적음.
		
		System.out.println("비밀번호를 입력하세요 : ");
		String password = sc.next();
		
		
		System.out.println("내가 방금 입력한 비밀번호 : " + password);
		System.out.println("객체 생성 시 지정한 비밀번호 : " + kim.pw);
		...
		System.out.println("equals의 결과 : " + (password.equals(kim.pw)));   //스트링 뿐 아니라 다른 객체도 그냥 ==쓰지말고 equals쓰자.
		
		//abc1234 의 출력 결과 :
		//내가 방금 입력한 비밀번호 : abc1234
		//객체 생성 시 지정한 비밀번호 : aaa1111
		//-------------------------------------
		//== 연산자의 결과 : false
		//equals의 결과 : false
